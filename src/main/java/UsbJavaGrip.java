 ...
 * @author GRIP
 */
public class UsbJavaGrip implements edu.wpi.first.vision.VisionPipeline {
	...
	public void process(Mat source0) {
		...
		double[] rgbThresholdRed = { 191.32995540341673, 255.0 };
		double[] rgbThresholdGreen = { 166.4017031117825, 255.0 };
		double[] rgbThresholdBlue = { 123.83093525179856, 255.0 };
		rgbThreshold(rgbThresholdInput, rgbThresholdRed, rgbThresholdGreen, rgbThresholdBlue, rgbThresholdOutput);

		// Step Find_Blobs0:
		Mat findBlobsInput = rgbThresholdOutput;
		double findBlobsMinArea = 10.0;
		double[] findBlobsCircularity = { 0.7014388489208633, 1.0 };
	...
	private void findBlobs(Mat input, double minArea, double[] circularity, Boolean darkBlobs, MatOfKeyPoint blobList) {
		SimpleBlobDetector blobbert = SimpleBlobDetector.create();
		try {
			...
			writer.close();
			blobbert.read(tempFile.getPath());
		} catch (IOException e) {
			e.printStackTrace();
		}

		blobbert.detect(input, blobList);
	}
}
